...
export default function ListExcursionToAdd(props) {
  ...
  // Fonction pour ajouter l'excursion
  const handleAddExcursion = (e) => {
    e.preventDefault();
    setIsSelected(true);

    // Utilisez une fonction pour mettre à jour correctement l'état
    setExcursionsId((prevExcursionsId) => {
      // Ajouter l'ID de l'excursion uniquement s'il est défini
    ...
    <tr>
      ...
      <td className="align-middle text-center">
        <span className="text-secondary text-xs font-weight-bold">
          {isSelected ? (
            // Si l'excursion est sélectionnée, afficher l'icône check-circle-fill
            <button
            ...
            // Si l'excursion n'est pas sélectionnée, afficher l'icône plus-circle
            <button
              style={{ backgroundColor: "white", border: "none" }}
